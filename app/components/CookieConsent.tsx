...
const cookies = [
  ...
  //   },
  {
    ...
    info: `We use Google Analytics to better understand how visitors interact with our website. These cookies help us collect anonymous data about website traffic, user behavior, and engagement. This information allows us to:
...
export default function CookieConsentBanner() {
  ...
  const saveConsent = (consentData: CookieConsent) => {
    ...
    // Here you would typically trigger your cookie/tracking scripts based on consent
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6 bg-primary">
      <Card className="w-full max-w-6xl mx-auto border">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="simple" className="space-y-4">
            <CardContent className="pt-4">
              <p>
                We use cookies to analyze how visitors interact with our
                website, allowing us to enhance your experience and improve our
                services.
              </p>
            </CardContent>
              ...
              <div className="space-y-4">
                {cookies.map((cookie) => (
                  ...
                  >
                    ...
                    >
                      <span className="mb-2">{cookie.title}</span>
                      <p className="leading-[1.2]">{cookie.description}</p>
                    </Label>
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={() =>
                          handleToggleConsent(cookie.id as keyof CookieConsent)
                        }
                      ...
                      <Dialog>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            <DialogTitle>{cookie.title}</DialogTitle>
                            <DialogDescription>{cookie.info}</DialogDescription>
                          </DialogHeader>
                        </DialogContent>
                      </Dialog>
                    </div>
